...
<div class="">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">{{ t('add_products') }}</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <div class="box-header">
                <h3 class="box-title">{{ t('add_products') }}</h3>
            </div><!-- end of box header -->
            <div class="box-body">

                <form @submit.prevent="productAdd" method="POST">
...
export default {
    ...
    methods: {
        ...
        productAdd() {
            ...
            this.axios.post(BaseUrl+'/api/products', this.form)
                .then(res => {
